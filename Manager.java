...
public interface Manager {
	 ...
	 * the following information for each exam question:
	 * "Question #" {questionNumber} {questionScore} " points out of " {totalQuestionPoints}
	 * The report will end with the following information:
